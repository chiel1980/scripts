...
### Install packages
#
packages=(pulseaudio pulseaudio-alsa pa-applet-git offlineimap msmtp midori connman midori parcellite gnome-keyring synaptics xorg-server xorg-xinit i3 vlc libreoffice fish mutt curl lynx atom connman-ui-gtk terminator urxvt git ufw terminator chromium keepassx2 thunar-volman thunar-archive-plugin thunar-media-tags-plugin gvfs thunar gvfs filezilla clusterssh)
