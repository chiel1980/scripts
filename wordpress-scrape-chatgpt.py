...
class WordPressScraper:
    ...
    def url_to_filepath(self, url):
        ...
        # Treat directories without extension
    ...
    def clean_wordpress_elements(self, soup):
        ...
        # Remove admin bars, footers, and common footer containers
        selectors = ['#wpadminbar', '.admin-bar', 'footer', '.site-footer', '.footer', '#footer', '[class*="footer"]', '.site-info']
        for sel in selectors:
            for el in soup.select(sel):
                el.decompose()

        # Remove WordPress.com marketing bar (old style)
        ...
        # Remove WordPress.com marketing bar (new style)
        ...
        # Remove comments mentioning WordPress
    ...
    def scrape(self):
        ...
        # Move scraped site to GitHub Pages folder
        self.move_output()
