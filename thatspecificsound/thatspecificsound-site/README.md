...
Java is only needed if you want fully offline validation (`pip install
vnujar`). Without it, `--validate` will use the public validator.w3.org
API instead (requires internet either way for the actual site content).
